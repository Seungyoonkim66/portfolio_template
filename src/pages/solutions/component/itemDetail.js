        ...
        <div className='desc'>
            {desc.map((d, i) =>
                <div key={i} className='TitleContent'>
                    ...
                    {d.image && <img src={`/image/${d.image}`} alt='desc' width='100%' />}
                </div>
            )}
    ...
    return (
        arch && (
            <div className='arch'>
                ...
                <img src={`/image/${arch}`} alt='architecture' width='100%' />
            </div>
        )
    );
}
        ...
        mp4 && (
            <div className='demo'>
                ...
                <video controls width='100%'>
                    <source src={`/video/${mp4}`} type="video/mp4" loop={true} />
                </video>
            </div>
        )
    );
